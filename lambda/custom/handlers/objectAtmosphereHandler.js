...
const ObjectAtmosphereHandler = Handler('ObjectAtmosphere', handlerInput => {
  ...
  return AtmosphereResponse(handlerInput, location);
});

module.exports = ObjectAtmosphereHandler;
